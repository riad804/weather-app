...
import 'package:weather_app/providers/get_weekly_weather_provider.dart';
import 'package:weather_app/screens/widgets/subscript_text.dart';
      ...
      data: (weatherData) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final dayOfWeek =
                DateTime.parse(weatherData.daily.time[index] as String).dayOfWeek;
            final date = weatherData.daily.time[index] as String;
            final temp = weatherData.daily.temperature2mMax[index] as double;
            final icon = weatherData.daily.weatherCode[index] as int;
